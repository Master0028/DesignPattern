...
public class TopicAdapterYellow extends RecyclerView.Adapter<TopicAdapterYellow.TopicViewHolder> {
    private List<Topic> topicList;

    // Constructor
    public TopicAdapterYellow(List<Topic> topicList) {
    ...
    public static class TopicViewHolder extends RecyclerView.ViewHolder {
        ...
        public TopicViewHolder(View itemView) {
            ...
            cardView.setOnClickListener(v -> {
                // Handle the click event here, e.g., open detailed topic view
            });
        }
    }
}
