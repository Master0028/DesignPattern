...
import com.example.vopet.activity.FlashcardWithClickCardActivity;
import com.example.vopet.R;
import com.example.vopet.model.Topic;

import java.util.List;

public class TopicAdapterGray extends RecyclerView.Adapter<TopicAdapterGray.TopicViewHolder> {
    private List<Topic> topicList;

    // Constructor
    public TopicAdapterGray(List<Topic> topicList) {
    ...
    public TopicViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.topic_item2, parent, false);
