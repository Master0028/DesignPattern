...
public class MultiViewInFlashcardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MultiViewInFlashcardAdapter(List<HistoryStudy> itemList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_FIRST_TIME) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.history_study_item_in_flashcard1, parent, false);
            return new FirstTimeViewHolder(view);
        } else {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.history_study_item_in_flashcard2, parent, false);
