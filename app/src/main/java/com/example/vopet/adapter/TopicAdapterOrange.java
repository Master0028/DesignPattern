...
public class TopicAdapterOrange extends RecyclerView.Adapter<TopicAdapterOrange.TopicViewHolder> {
    private List<Topic> topicList;
    private Context context;
    private String folderName;
    private FirebaseFirestore db;
    public TopicAdapterOrange(Context context, List<Topic> topicList) {
