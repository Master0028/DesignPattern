...
import com.example.vopet.adapter.TopicAdapterOrangeInMulChoice;
...
public class MultipleChoiceActivity extends AppCompatActivity {
    ...
    private TopicAdapterOrangeInMulChoice topicAdapterOrange;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnAdd) {
                    Intent i = new Intent(MultipleChoiceActivity.this, PublicTopicActivity.class);
                    startActivity(i);
                }
            }
        });
        btnHome1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnHome) {
                    Intent i = new Intent(MultipleChoiceActivity.this, HomeActivity.class);
                    startActivity(i);
                }
            }
        });
        btnTopics1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnTopics) {
                    Intent i = new Intent(MultipleChoiceActivity.this, TopicActivity.class);
                    startActivity(i);
                }
            }
        });
        btnProfile1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnProfile) {
                    Intent i = new Intent(MultipleChoiceActivity.this, ProfileActivity.class);
                    startActivity(i);
                }
            }
        });
        btnCommunity1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnCommunity) {
                    Intent i = new Intent(MultipleChoiceActivity.this, CommunityActivity.class);
                    startActivity(i);
                }
            }
        });
        ...
        topicAdapterOrange = new TopicAdapterOrangeInMulChoice(this, topicList);
        recyclerView.setAdapter(topicAdapterOrange);
        loadAllTopics(currentUser);
        btnMenu.setOnClickListener(v -> {
            Dialog dialog = new Dialog(MultipleChoiceActivity.this);
            ...
            btnFlashcard.setOnClickListener(view -> {
                Intent intent = new Intent(MultipleChoiceActivity.this, FlashcardActivity.class);
                startActivity(intent);
            });
            Button btnTopics = dialog.findViewById(R.id.btnTopics);
            btnTopics.setOnClickListener(view -> {
                Intent intent = new Intent(MultipleChoiceActivity.this, TopicActivity.class);
                startActivity(intent);
            });
            Button btnFolders = dialog.findViewById(R.id.btnFolders);
            btnFolders.setOnClickListener(view -> {
                Intent intent = new Intent(MultipleChoiceActivity.this, FolderActivity.class);
                startActivity(intent);
            });
            Button btnChoice = dialog.findViewById(R.id.btnChoice);
            btnChoice.setOnClickListener(view -> {
                Intent intent = new Intent(MultipleChoiceActivity.this, MultipleChoiceActivity.class);
                startActivity(intent);
            });
            Button btnProfile = dialog.findViewById(R.id.btnProfile);
            btnProfile.setOnClickListener(view -> {
                Intent intent = new Intent(MultipleChoiceActivity.this, ProfileActivity.class);
                startActivity(intent);
            });
            Button btnFind = dialog.findViewById(R.id.btnFind);
            btnFind.setOnClickListener(view -> {
                Intent intent = new Intent(MultipleChoiceActivity.this, FindAndFillActivity.class);
                startActivity(intent);
            });
            Button btnCommunity = dialog.findViewById(R.id.btnCommunity);
            btnCommunity.setOnClickListener(view -> {
                Intent intent = new Intent(MultipleChoiceActivity.this, CommunityActivity.class);
                startActivity(intent);
            });
            ...
            btnSetting.setOnClickListener(view -> {
                Intent intent = new Intent(MultipleChoiceActivity.this, SettingActivity.class);
                startActivity(intent);
            });
            dialog.show();
    ...
    private void loadAllTopics(String userId) {
        ...
        db.collection("topics")
                .whereEqualTo("ownerId", userId) // Lọc tất cả topics theo creatorId
                .get()
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        tvCountTopic.setText(String.valueOf(count));
                        topicAdapterOrange.notifyDataSetChanged(); // Cập nhật giao diện
                    } else {
                        Log.e("FirestoreError", "Error loading topics: " + task.getException().getMessage());
                    }
                });
    }
}