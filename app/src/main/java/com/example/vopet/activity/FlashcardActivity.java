...
import com.example.vopet.adapter.TopicAdapterGray;
...
public class FlashcardActivity extends AppCompatActivity {
    ...
    private TopicAdapterGray topicAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnAdd) {
                    Intent i = new Intent(FlashcardActivity.this, PublicTopicActivity.class);
                    startActivity(i);
                }
            }
        });
        btnHome1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnHome) {
                    Intent i = new Intent(FlashcardActivity.this, HomeActivity.class);
                    startActivity(i);
                }
            }
        });
        btnTopics1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnTopics) {
                    Intent i = new Intent(FlashcardActivity.this, TopicActivity.class);
                    startActivity(i);
                }
            }
        });
        btnProfile1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnProfile) {
                    Intent i = new Intent(FlashcardActivity.this, ProfileActivity.class);
                    startActivity(i);
                }
            }
        });
        btnCommunity1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnCommunity) {
                    Intent i = new Intent(FlashcardActivity.this, CommunityActivity.class);
                    startActivity(i);
                }
            }
        });
        ...
        topicAdapter = new TopicAdapterGray(topicList);
        recyclerView.setAdapter(topicAdapter);

        loadAllTopics(SessionSingleton.getInstance().getUserId());

        btnMenu.setOnClickListener(v -> {
            Dialog dialog = new Dialog(FlashcardActivity.this);
            ...
            btnTopics.setOnClickListener(view -> {
                Intent intent = new Intent(FlashcardActivity.this, TopicActivity.class);
                startActivity(intent);
            });
            Button btnFolders = dialog.findViewById(R.id.btnFolders);
            btnFolders.setOnClickListener(view -> {
                Intent intent = new Intent(FlashcardActivity.this, FolderActivity.class);
                startActivity(intent);
            });
            Button btnChoice = dialog.findViewById(R.id.btnChoice);
            btnChoice.setOnClickListener(view -> {
                Intent intent = new Intent(FlashcardActivity.this, MultipleChoiceActivity.class);
                startActivity(intent);
            });
            Button btnProfile = dialog.findViewById(R.id.btnProfile);
            btnProfile.setOnClickListener(view -> {
                Intent intent = new Intent(FlashcardActivity.this, ProfileActivity.class);
                startActivity(intent);
            });
            Button btnFind = dialog.findViewById(R.id.btnFind);
            btnFind.setOnClickListener(view -> {
                Intent intent = new Intent(FlashcardActivity.this, FindAndFillActivity.class);
                startActivity(intent);
            });
            Button btnCommunity = dialog.findViewById(R.id.btnCommunity);
            btnCommunity.setOnClickListener(view -> {
                Intent intent = new Intent(FlashcardActivity.this, CommunityActivity.class);
                startActivity(intent);
            });
            ...
            btnSetting.setOnClickListener(view -> {
                Intent intent = new Intent(FlashcardActivity.this, SettingActivity.class);
                startActivity(intent);
            });
            dialog.show();
