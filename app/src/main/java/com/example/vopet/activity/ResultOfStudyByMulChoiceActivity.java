...
public class ResultOfStudyByMulChoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_of_study_by_mul_choice);
        ...
        Toast.makeText(this, "score: " + totalScore, Toast.LENGTH_SHORT).show();
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnAdd) {
                    Intent i = new Intent(ResultOfStudyByMulChoiceActivity.this, PublicTopicActivity.class);
                    startActivity(i);
                }
            }
        });
        btnHome1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnHome) {
                    Intent i = new Intent(ResultOfStudyByMulChoiceActivity.this, HomeActivity.class);
                    startActivity(i);
                }
            }
        });
        btnTopics1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnTopics) {
                    Intent i = new Intent(ResultOfStudyByMulChoiceActivity.this, TopicActivity.class);
                    startActivity(i);
                }
            }
        });
        btnProfile1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnProfile) {
                    Intent i = new Intent(ResultOfStudyByMulChoiceActivity.this, ProfileActivity.class);
                    startActivity(i);
                }
            }
        });
        btnCommunity1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(view.getId() == R.id.btnCommunity) {
                    Intent i = new Intent(ResultOfStudyByMulChoiceActivity.this, CommunityActivity.class);
                    startActivity(i);
                }
            }
        });
    ...
    private void saveHistoryToFirebase() {
        Log.d("Restart", "saveHistoryToFirebase called");
                        ...
                        db.collection("topics").document(topicId).collection("vocabularies")
                                ...
                                .addOnSuccessListener(vocabSnapshots -> {
                                    ...
                                    db.collection("users").document(userId).collection("history")
                                            .whereEqualTo("typeStudy", "Multiplechoice")
                                            .get()
    ...
    private void restartStudy() {
        ...
        Intent intent = new Intent(ResultOfStudyByMulChoiceActivity.this, StudyTopicInMulChoiceActivity.class);
